...
return {
  keys = {
    ...
    -- Tab新規作成
    { key = "t", mods = "SHIFT", action = act({ SpawnTab = "CurrentPaneDomain" }) },
    -- Tabを閉じる
    { key = "w", mods = "SHIFT", action = act({ CloseCurrentTab = { confirm = true } }) },
    { key = "}", mods = "SHIFT", action = act({ MoveTabRelative = 1 }) },
    ...
    -- タブ切替 Shift + 数字
    { key = "1", mods = "SHIFT", action = act.ActivateTab(0) },
    { key = "2", mods = "SHIFT", action = act.ActivateTab(1) },
    { key = "3", mods = "SHIFT", action = act.ActivateTab(2) },
    { key = "4", mods = "SHIFT", action = act.ActivateTab(3) },
    { key = "5", mods = "SHIFT", action = act.ActivateTab(4) },
    { key = "6", mods = "SHIFT", action = act.ActivateTab(5) },
    { key = "7", mods = "SHIFT", action = act.ActivateTab(6) },
    { key = "8", mods = "SHIFT", action = act.ActivateTab(7) },
    { key = "9", mods = "SHIFT", action = act.ActivateTab(-1) },
